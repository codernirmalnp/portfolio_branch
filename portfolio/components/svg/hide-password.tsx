...
export const HidePassword = ({ onClick }) => {

    return (
        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
            height={"24px"} width="24px"
            onClick={onClick}
            viewBox="0 0 330 330" enableBackground="new 0 0 330 330;" >
            <path fill="gray" id="XMLID_2_" d="M325.607,304.394l-63.479-63.479c38.57-29.035,63.522-64.92,65.247-67.437c3.501-5.11,3.501-11.846,0-16.956
